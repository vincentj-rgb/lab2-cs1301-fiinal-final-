...
st.title("Study Hour Survey 📝")
st.write("Please fill out the form below to add how much you studied to the data.")
...
with st.form("survey_form"):
    ...
    hours_input = st.number_input("Enter hours studied:", value=1.0, step=0.5, min_value=0.0)
    ...
    if submitted:
        ...
        new_data.to_csv(file_path,mode = "a", header=not, index=False)
